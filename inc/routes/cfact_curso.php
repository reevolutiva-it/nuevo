...
add_action('rest_api_init', function () {
    ...
    register_rest_route('cfact/v1', 'cfact-curso-delete', array(
        'methods' => 'DELETE',
    ...
    register_rest_route('cfact/v1', 'cfact-course-section', array(
        'methods' => 'POST',
...
function cfact_curso_section_callback($request){
    ...
    if (array_key_exists('course-section', $body) && array_key_exists('course_id', $body)) {
        ...
        //error_log(print_r($course_section, true));
        //error_log(print_r($course_id, true));

        update_post_meta($course_id, "course_sections", json_encode($course_section, JSON_UNESCAPED_UNICODE));
